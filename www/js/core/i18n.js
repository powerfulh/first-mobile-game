...
const EN = {
	...
	'공중 지름길': 'Air Shortcut',
	'이 맵에는 공중 타입이 이용할 수 있는 지름길이 있습니다': 'This map has an air-only shortcut.',
	'정규 경로와 번갈아 이용합니다': 'Used alternately with the regular route.',
	...
	'처음부터 등장하는 기본 지상 유닛': 'Basic ground unit from the start',
	...
	'일정 웨이브부터 등장 · 공중 공격 가능 타워만 처리': 'Appears from a certain wave · only air-capable towers can hit',
	'웨이브가 오를수록 출현 확률 상승': 'Spawn rate rises with the wave',
	'HP는 지상보다 낮게 시작해 후반에 지상과 같아짐': 'HP starts below ground, reaching parity later',
	'지상 전담 타워는 공격 불가, 스카웃 계열로 대비': 'Ground-only towers cannot hit; use Scout line',
	'후반 등장 · 자가 회복, 느린 지상': 'Appears late · self-healing, slow ground',
	'HP는 일반 지상과 같고 이동 속도가 느림': 'Same HP as normal ground, slower movement',
	'HP가 가득 차지 않으면 매초 스스로 회복': 'Heals itself each second while not full',
	'후반으로 갈수록 회복량 증가': 'Heal rate increases in later waves',
	'후반 등장 · 처치 시 장벽 생성': 'Appears late · spawns a barrier on death',
	'공중 타입, HP/속도는 일반 적과 동일': 'Air type; HP/speed same as normal enemies',
	'처치 시 그 자리에 튼튼한 장벽 생성': 'On death spawns a tough barrier in place',
