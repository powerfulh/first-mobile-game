...
export const MAPS = {
	...
	map8: {
		...
		waveComposition: {
			...
			barrierStartWave: 121, // 장벽 적: wave 121부터 0.4% (+0.4%/wave → wave 130에 상한 4%). 151~160 상향으로 최종 8% (barrierBoostWave)
			shieldCapRamp3Wave: 140, // 방어막 출현 확률 상한 +3%/wave 확장을 wave 141~150으로 (기본 181~190 → 50%→80%)
			barrierBoostWave: 150, // 장벽 출현 확률 상향을 wave 151~160으로 (+0.4%/wave 누적 +4% → 최종 8%)
		},
		fixedTowers: [
